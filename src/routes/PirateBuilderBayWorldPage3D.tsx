...
import { PirateBuilderBayWorldView } from '../features/island-map/three/PirateBuilderBayWorldView';
 ...
 */
export function PirateBuilderBayWorldPage3D() {
  ...
  return (
    <IslandLayout childId={childId}>
      <PirateBuilderBayWorldView childId={childId} ageBand={ageBand} />
    </IslandLayout>
  );
}
