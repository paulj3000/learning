...
import { WonderwildForestWorldView } from '../features/island-map/WonderwildForestWorldView';
...
export function WonderwildForestWorldPage() {
  ...
  return (
    <IslandLayout childId={childId}>
      <WonderwildForestWorldView childId={childId} avatarKey={avatarKey} ageBand={ageBand} />
    </IslandLayout>
  );
}
