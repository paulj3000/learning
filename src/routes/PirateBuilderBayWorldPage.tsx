...
import { PirateBuilderBayWorldView } from '../features/island-map/PirateBuilderBayWorldView';
...
export function PirateBuilderBayWorldPage() {
  ...
  if (loadState === 'loading') {
    return (
      <IslandLayout childId={childId}>
        <p>Loading Pirate Builder Bay...</p>
      </IslandLayout>
    );
  }
  if (loadState === 'not-found' || loadState === 'error') {
    return (
      <IslandLayout childId={childId}>
        <p role="alert">Something went wrong loading Pirate Builder Bay.</p>
      </IslandLayout>
    );
  }
  ...
  return (
    <IslandLayout childId={childId}>
      <PirateBuilderBayWorldView childId={childId} avatarKey={avatarKey} ageBand={ageBand} />
    </IslandLayout>
  );
}
