/**
 * Pixel-space walk-in zone geometry for Bolt's Workshop, keyed by
 ...
 */
import { HARBOR_EXIT_TILE_RECT } from './boltsWorkshopTilemap';
...
export const BOLTS_WORKSHOP_ZONES: Record<string, PixelRect> = {
  'bolts-workshop-harbor-exit': tileRectToPixels(
